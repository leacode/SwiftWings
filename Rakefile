...
PROJECT="SwiftWings.xcodeproj"
IOS_FRAMEWORK_SCHEME="SwiftWings"
...
task :spm_xcode do
  sh "swift package generate-xcodeproj --enable-code-coverage --output SwiftWings-SPM.xcodeproj"
  sh "open SwiftWings-SPM.xcodeproj"
end
...
task :clean do
  ...
  sh "rm -rf ~/Library/Developer/Xcode/DerivedData/SwiftWings-*"
